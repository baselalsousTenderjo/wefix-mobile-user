...
/// B2B-specific service provider section - uses "Technician Actions" instead of "Service Provider Actions"
class ContainerServiceProvideSectionB2B extends StatelessWidget {
  const ContainerServiceProvideSectionB2B({super.key});
